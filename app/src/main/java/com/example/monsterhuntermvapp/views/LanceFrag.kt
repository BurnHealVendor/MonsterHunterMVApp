...
import com.example.monsterhuntermvapp.databinding.FragmentLanceBinding
...
class LanceFrag : Fragment() {

    @Inject
    lateinit var motionValuesRepo: MotionValuesRepo

    private val binding by lazy {
        FragmentLanceBinding.inflate(layoutInflater)
    }
