...
import com.example.monsterhuntermvapp.databinding.FragmentLongSwordBinding
...
class LongSwordFrag : Fragment() {

    @Inject
    lateinit var motionValuesRepo: MotionValuesRepo

    private val binding by lazy {
        FragmentLongSwordBinding.inflate(layoutInflater)
    }
    ...
    override fun onCreateView(
        ...
        binding.longSwordRecView.apply {
