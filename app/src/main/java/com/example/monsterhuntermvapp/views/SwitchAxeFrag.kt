...
import com.example.monsterhuntermvapp.databinding.FragmentSwitchAxeBinding
...
class SwitchAxeFrag : Fragment() {

    @Inject
    lateinit var motionValuesRepo: MotionValuesRepo

    private val binding by lazy {
        FragmentSwitchAxeBinding.inflate(layoutInflater)
    }
    ...
    override fun onCreateView(
        ...
        binding.switchAxeRecView.apply {
