...
import com.example.monsterhuntermvapp.databinding.FragmentDualBladesBinding
...
class DualBladesFrag : Fragment() {

    @Inject
    lateinit var motionValuesRepo: MotionValuesRepo

    private val binding by lazy {
        FragmentDualBladesBinding.inflate(layoutInflater)
    }
    ...
    override fun onCreateView(
        ...
        binding.dualBladesRecView.apply {
