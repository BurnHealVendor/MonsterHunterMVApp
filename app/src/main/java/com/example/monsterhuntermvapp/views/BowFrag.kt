...
import com.example.monsterhuntermvapp.databinding.FragmentBowBinding
...
class BowFrag : Fragment() {

    @Inject
    lateinit var motionValuesRepo: MotionValuesRepo

    private val binding by lazy {
        FragmentBowBinding.inflate(layoutInflater)
    }
