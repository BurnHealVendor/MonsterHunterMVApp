...
import com.example.monsterhuntermvapp.databinding.FragmentGunlanceBinding
...
class GunlanceFrag : Fragment() {

    @Inject
    lateinit var motionValuesRepo: MotionValuesRepo

    private val binding by lazy {
        FragmentGunlanceBinding.inflate(layoutInflater)
    }
