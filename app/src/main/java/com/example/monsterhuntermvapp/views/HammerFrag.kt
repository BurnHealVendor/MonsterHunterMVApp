...
import com.example.monsterhuntermvapp.databinding.FragmentHammerBinding
...
class HammerFrag : Fragment() {

    @Inject
    lateinit var motionValuesRepo: MotionValuesRepo

    private val binding by lazy {
        FragmentHammerBinding.inflate(layoutInflater)
    }
